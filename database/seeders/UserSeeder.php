...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        User::insert([
            ...
            ['id' => 4, 'name' => 'Teacher Ma Ma', 'email' => 'mama@gmail.com', 'password' => Hash::make('12345678'), 'role_id' => 4, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 5, 'name' => 'Teacher Hla Hla', 'email' => 'hlahla@gmail.com', 'password' => Hash::make('12345678'), 'role_id' => 5, 'created_at' => $now, 'updated_at' => $now],
